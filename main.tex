...
\begin{itemize}
	\item Firmware compilado con ESP-IDF v5.x y ESP-MDF
...
\begin{enumerate}
	...
	\item \textbf{Capacidad de batería:} Dimensionar los packs de baterías
	      según la frecuencia esperada de activaciones. El diseño del
	      prototipo con \gls{buck-converter} permite alimentación desde un
	      amplio rango de voltajes de entrada (4.5V-40V), facilitando el uso
	      de packs de baterías \gls{18650} en diversas configuraciones (2S,
	      3S, 4S) o sistemas de recarga solar.
