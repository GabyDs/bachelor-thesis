...
\begin{description}
	\item[Autonomía energética:] Los nodos de cámara \gls{ESP32} presentan un
	      ...
	      con baterías convencionales es limitada comparada con cámaras trampa
	      comerciales optimizadas durante años para este propósito.
...
El \gls{sensor-pir} (\textit{Passive Infrared}) detecta movimiento mediante la
medición de cambios en los niveles de radiación infrarroja emitida por objetos
en su campo de visión. El sensor contiene un elemento piroeléctrico dividido
en dos zonas: cuando un objeto emisor de calor (como un humano o animal) cruza
de una zona a otra, se genera una diferencia de voltaje que activa la detección.
...
\begin{itemize}
	...
	\item Espacio para baterías y circuitos de carga
